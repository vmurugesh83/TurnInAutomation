...
<Serializable()> _
Partial Public Class EcommFabOrigInfo
    ...
    Private _FabricationId As Integer
    Private _Fabrication As String
    Private _FabricationSource As String
    Private _StyleSkuFabDescription As String
    Private _OriginationCode As Integer
    Private _Origination As String
    Private _OriginationSource As String
    ...
    <DataObjectField(True)> _
    Public Property FabricationId() As Integer
        Get
            Return _FabricationId
        End Get
        Set(ByVal value As Integer)
            _FabricationId = value
        End Set
    End Property
    ...
    <DataObjectField(True)> _
    Public Property FabricationSource() As String
        Get
            Return _FabricationSource
        End Get
        Set(ByVal value As String)
            _FabricationSource = value
        End Set
    End Property
    ...
    <DataObjectField(True)> _
    Public Property OriginationCode() As Integer
        Get
    ...
    <DataObjectField(True)> _
    Public Property OriginationSource() As String
        Get
            Return _OriginationSource
        End Get
        Set(ByVal value As String)
            _OriginationSource = value
        End Set
    End Property
    ...
    <DataObjectField(True)> _
    Public Property LastModTs() As Date?
        Get
            Return _LastModTs
        End Get
