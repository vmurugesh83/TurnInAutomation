...
#Region "Properties"
    ...
    Public Property GXSCopyViewSearchCtrl() As GXSCopyViewSearchCtrl
        Get
            Return _gxsCopyViewSearchCtrl
        End Get
        Set(ByVal value As GXSCopyViewSearchCtrl)
            _gxsCopyViewSearchCtrl = value
        End Set
    End Property
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ajaxSett.UpdatedControls.Add(New AjaxUpdatedControl(Me.GXSCopyViewSearchCtrl.UniqueID, String.Empty))
        RadAjaxManagerProxy1.AjaxSettings.Add(ajaxSett)

        If Not Page.IsPostBack Then

            lblPageHeader.Text = "GXS Copy View"
    ...
    Private Function GetComboInt16(ByVal cmb As RadComboBox) As Int16
        ...
        '    ret = CType(cmb.SelectedValue, Int16)
        'End If
        'Return ret
