...
.controller('orderCartCtrl', ['$scope', '$location', '$modal', '$state', '$log', 'customer', '$rootScope', 'orderCart', 'bigTicketValidate', '$document', 'numberOnlyKeyPressValidator', 'itemSearch', 'loggerService','$stateParams',
    function ($scope, $location, $modal, $state, $log, customer, $rootScope, orderCart, bigTicketValidate, $document, $numberOnlyKeyPressValidator, $itemSearch, $loggerService, $stateParams) {
