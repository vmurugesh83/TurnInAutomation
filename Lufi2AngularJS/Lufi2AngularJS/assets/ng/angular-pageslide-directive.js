    ...
    function ($document) {
        ...
        return {
            ...
            link: function ($scope, el, attrs) {
                ...
                param.zindex = 9999; // Override with custom CSS
                ...
                //calling scope's psOpen variable
                var parentPsOpen = attrs['psOpen']; //gives text of attribute ps-Open
                ...
                /* add my backdrop*/
                var backdrop = angular.element('<div>');
                var myBody=angular.element($document[0].body);
                myBody.append(backdrop);
                ...
                backdrop.hide();
                backdrop.click(function () { angular.element('pageslide').scope().$apply(parentPsOpen.toString() + '=false'); });
                ...
                switch (param.side){
                    case 'right':
                        ...
                        slider.style.right = attrs.psCustomRight ||  '-10px';
                        break;
                    case 'left':
                        slider.style.height = attrs.psCustomHeight || '100%';   
                        slider.style.top = attrs.psCustomTop || '0px';
                        slider.style.bottom = attrs.psCustomBottom || '0px';
                        slider.style.left = attrs.psCustomLeft || '-10px';
                        break;
                    case 'top':
                        slider.style.width = attrs.psCustomWidth || '100%';   
                        slider.style.left = attrs.psCustomLeft || '0px';
                        slider.style.top = attrs.psCustomTop || '-10px';
                        slider.style.right = attrs.psCustomRight || '0px';
                        break;
                    case 'bottom':
                        slider.style.width = attrs.psCustomWidth || '100%'; 
                        slider.style.bottom = attrs.psCustomBottom || '-10px';
                        slider.style.left = attrs.psCustomLeft || '0px';
                        slider.style.right = attrs.psCustomRight || '0px';
                        break;
                }
