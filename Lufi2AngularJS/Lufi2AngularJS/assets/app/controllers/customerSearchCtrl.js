angular.module('customerSearch', [])
    .controller('customerSearchCtrl', ['$scope', 'customer', '$location', 'numberOnlyKeyPressValidator',
        '$modal', 'msrService', '$rootScope', '$state', 'loggerService', '$http', 'POSService', '$filter', 'orderCart', 'securityService',
        function ($scope, $customer, $location, $numberOnlyKeyPressValidator, $modal, $msrService, $rootScope, $state, loggerService, $http, $POSService, $filter, $orderCart, $securityService) {
            ...
            if ($scope.isCsr === undefined || $scope.isCsr === null || !$scope.isCsr){
