...
.controller('orderSearchCtrl', ['$scope', 'order', '$filter', 'ngTableParams', '$location', 'numberOnlyKeyPressValidator', 'loggerService', '$timeout', function ($scope, $order, $filter, ngTableParams, $location, $numberOnlyKeyPressValidator, $loggerService, $timeout) {
    ...
    $scope.orderNoPaste = function ($event) {
    ...
    var handlePastedOrderNo = function (pastedText) {
        ...
        $timeout(function () {
            $scope.formInput.orderNumber = cleansedText;
        }, 3);
    };
