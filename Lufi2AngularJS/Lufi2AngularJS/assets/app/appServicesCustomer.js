...
appServices.factory('customer', ['$http', '$cacheFactory', 'serviceArrayFix', '$rootScope', 'isPoBoxAddress', 'loggerService', 'sendSMTPErrorEmail', '$filter',
    function ($http, $cacheFactory, serviceArrayFix, $rootScope, $isPoBoxAddress, $loggerService, $sendSMTPErrorEmail, $filter) {
                ...
                input: {
                    CustomerContactList: {
                        CustomerContact: [{
                            ...
                            _DateOfBirth: "",
                            _DayFaxNo: "",
                            _DayPhone: $filter('phoneFormatRemove')(customer.DayPhone),
                            _Department: "Legends",
                            _EmailID: customer.EmailAddress,
                            _EveningFaxNo: "",
                            _EveningPhone: "",
                ...
                "input": {
                    ...
                    "CustomerContactList": {
                        "CustomerContact": [{
                            ...
                            "_DateOfBirth": "",
                            "_DayFaxNo": "",
                            "_DayPhone": $filter('phoneFormatRemove')(modifiedAddress.PersonInfo._DayPhone),
                            "_Department": "",
                            "_EmailID": modifiedAddress.PersonInfo._EMailID,
                            "_EveningFaxNo": "",
                            "_EveningPhone": $filter('phoneFormatRemove')(modifiedAddress.PersonInfo._EveningPhone),
