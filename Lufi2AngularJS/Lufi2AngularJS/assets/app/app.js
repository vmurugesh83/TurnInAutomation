...
app.controller('appCtrl',['$scope', 'securityService', function ($scope, $securityService) {
...
app.config(['$httpProvider', '$stateProvider', '$urlRouterProvider', function ($httpProvider, $stateProvider, $urlRouterProvider) {
    ...
    .state('pickUpInStore', {
        ...
        views: {
            'main@': {
                templateUrl: 'html/pickUpInStore/pickUpInStore.html',
                controller: 'pickUpInStoreCtrl',
            }
        },
        data: {
    ...
    .state('alternatePickAndPack', {
        url: '/AlternatePickAndPack',
        views: {
            'main@': {
                templateUrl: 'html/pickUpInStore/alternatePickAndPack.html',
            controller: 'alternatePickAndPackCtrl',
            }
        },
        data: {
            displayName: 'Alternate Pick & Pack',
            isBreadCrumbDisplay: true
        }
    })
    .state('pickingConfirm', {
        url: '/pickList',
        views: {
            'main@': {
                templateUrl: 'html/pickUpInStore/pickingConfirm.html',
                controller: 'pickingConfirmCtrl',
            }
        },
        data: {
         ...
         .state('confirmPickup', {
             ...
             data: {
                 displayName: 'Confirm Pick up In Store',
                 isBreadCrumbDisplay: false
             }
         })
    .state('packingConfirm', {
        url: '/packConfirmation',
        views: {
            'main@': {
                templateUrl: 'html/pickUpInStore/packConfirm.html',
                controller: 'packConfirmCtrl',
            }
        },
        data: {
            displayName: 'Pack Confirm',
            isBreadCrumbDisplay: true
        }
    })
    ...
    .state('bopisReport', {
        ...
        views: {
            'main@': {
                templateUrl: 'html/pickUpInStore/bopisReport.html',
                controller: 'bopisReportCtrl',
            }
        },
        data: {
            displayName: 'Bopis Report',
            isBreadCrumbDisplay: true
        }
    })
