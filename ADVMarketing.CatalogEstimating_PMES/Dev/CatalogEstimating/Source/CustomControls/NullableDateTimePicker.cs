...
{
    /// <summary>Represents a Windows date time picker control. It enhances the .NET standard 
    /// <b>DateTimePicker</b> control with the possibility to show empty values (null values).</summary>
    [ComVisible( false )]
    public class NullableDateTimePicker : System.Windows.Forms.DateTimePicker
    {
        ...
        [Browsable( true ), DefaultValue( DateTimePickerFormat.Long ), TypeConverter( typeof( Enum ) )]
        ...
        /// <summary>Gets or sets the string value that is assigned to the control as null value.</summary>
        ...
        /// <summary>Stores the current format of the DateTimePicker as string.</summary>
        ...
        /// <summary>Sets the format according to the current DateTimePickerFormat.</summary>
        ...
        /// <summary>Sets the <b>DateTimePicker</b> to the value of the <see cref="NullValue"/> property.</summary>
        ...
        /// <summary>Sets the <b>DateTimePicker</b> back to a non null value.</summary>
